    ...
    uploadTask.on(
      ...
      async () => {
        try {
          ...
          setUploading(false);
          await addDoc(
            collection(db, `users/folders/${folderName}/files/metadata`),
            {
              name: file.name,
              url: downloadURL,
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-col justify-center lg:px-8 mx-auto max-w-screen-xl px-6 py-3">
        ...
        {uploading && (
          <p className="text-blue-gray-900 text-center">
        ...
        <div className="mt-10 flex flex-row  justify-center">
          <Card className="w-100" placeholder={undefined}>
            ...
            <CardBody  placeholder={undefined} className="flex flex-col items-center">
                  ...
                  <h2 className="text-black mr-2 mb-2">(aligned to the fields of specialization):</h2>
                  <div className="relative flex w-full max-w-96 items-center">
                    <Input
                      type="file"
                      size="md"
                  ...
                  <h2 className="text-black mr-2 mb-2"> employee from the previous
                    employer:</h2>
                  <div className="relative flex w-full max-w-96 items-center">
                    <Input
                      type="file"
